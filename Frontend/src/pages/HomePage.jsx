  ...
  return (
    <div className="flex flex-col items-center justify-center w-full relative">
      ...
      <label
        ...
        className="flex flex-col items-center justify-center w-full h-64 border-2  border-dashed rounded-lg cursor-pointer bg-gray-800  dark:bg-gray-700 border-gray-600 hover:border-gray-500 hover:bg-gray-600"
      >
