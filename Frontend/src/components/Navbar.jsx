...
//   { id: "/flow-chart", title: "Flow Chart" },
...
//   return (
//     <nav
//       className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-white shadow-md`}
//     >
...
//           onClick={() => setActive("")}
//         >
//           <p className="text-[18px] font-bold cursor-pointer text-blue-600">
//             Compliance Taxonomy
//           </p>
//         </Link>
...
//                   <RadioGroup onChange={(value) => setActive(value)}>
//                     <div className="p-1">
//                       {navLinks.map((link) =>
//                         link.id === "/" ? (
//                           <RadioGroup.Option value={link.title} key={link.id}>
//                             <Menu.Item>
//                               <Link
//                                 to={link.id}
//                                 className={`group flex w-full items-center rounded-md px-2 py-2 text-gray-700 hover:text-blue-500`}
//                               >
//                                 {link.title}
//                               </Link>
//                             </Menu.Item>
